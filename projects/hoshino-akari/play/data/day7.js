...
window.HOSHINO.days[7] = [
...

  {
    ...
    options: [
      ...
      {
        label: "先收進口袋，不細看。", _dbg: "distance +1（不敢正面承接）",
        add: { distance: 1 },
        reaction: [
          { type: "line", who: "narration", text: "我先收進口袋。現在還不能看。看了，今天會更難結束。" },
          { type: "line", who: "narration", text: "我把它收進口袋。沒有打開。" },
        ],
      },
    ],
  },
  ...
  { type: "line", who: "narration", text: "她沒有把它收進口袋。就那樣握著，握了很久。", pause: 2.0, cg: "clear" },
  ...
  /* ── S5 算數鬥嘴 ── */
  {
    ...
    options: [
      ...
      {
        label: "「如果妳說不算，我也不意外。」", _dbg: "regret +1（沒接住）",
        add: { regret: 1 },
        reaction: [
          { type: "line", who: "me", text: "「如果妳說不算，我也不意外。」" },
          { type: "line", who: "narration", text: "她瞪我。" },
          { type: "line", who: "akari", text: "「你把我當成什麼貓。」" },
  ...
  { type: "line", who: "akari", text: "「很貴。」", speed: "slow" },
  ...
  { type: "line", who: "akari", text: "「想確認她下面，還有一個我。」", speed: "slow" },
  { type: "line", who: "narration", text: "我沒有說話。" },
  { type: "line", who: "narration", text: "風從大路那頭灌進雨棚。她把外套拉緊了一點。", se: "wind" },

  /* 未來可能性段：warm_true 門檻才出全套；否則短版自然收束 */
  {
    ...
    then: [
      ...
      { type: "line", who: "narration", text: "沉默。", pause: 0.8 },
    ],
    else: [
      { type: "line", who: "akari", text: "「如果哪天，」", pause: 0.4 },
      { type: "line", who: "akari", text: "「我真的可以，自己走進便利商店。」" },
