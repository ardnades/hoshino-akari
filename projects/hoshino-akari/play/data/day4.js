...
window.HOSHINO.days[4] = [
...

  {
    ...
    options: [
      ...
      {
        label: "「沒多想，滑掉。」", _dbg: "+0", flavor: true,
        reaction: [
...

  {
    ...
    options: [
      {
        label: "「邁開腳步，和平常一樣的方向。」", _dbg: "+0", flavor: true,
        reaction: [
  ...
  { type: "line", who: "akari", text: "「別露出那種臉。」她打斷我，「我沒被抓。」", speed: "instant", expr: "直起身嘴硬", depth: "normal" },
  { type: "line", who: "narration", text: "她直起身，拍了拍連帽衣。" },
  { type: "line", who: "akari", text: "「只是最近，路上的眼睛有點多。」", speed: "slow" },
  { type: "line", who: "narration", text: "她看了一眼便利商店的玻璃門。", expr: "看玻璃門眼神警戒", mask: "口罩", depth: "far" },
  ...
  { type: "line", who: "narration", text: "她接過罐子，沒有開。", cg: "clear", expr: "貼罐子放鬆", motion: "fade_in", depth: "near" },
  ...
  { type: "line", who: "narration", text: "她捧著罐子，看著停車格的白線，忽然開口。", expr: "看白線出神", depth: "normal" },
  ...
  { type: "line", who: "narration", text: "她撕蓋子。", expr: "凍手撕蓋", depth: "near" },
    ...
    options: [
      {
        ...
        reaction: [
          ...
          { type: "line", who: "akari", text: "「對。」她把布丁挖了一大口，「所以很壞。」", expr: "嘴硬被逗", depth: "normal" },
        ],
      },
      {
        label: "「不急的話，再吃一會。」", _dbg: "+0", flavor: true,
        reaction: [
          { type: "line", who: "me", text: "「不急的話，再吃一會。」" },
          { type: "line", who: "narration", text: "她的湯匙停在半空。" },
          { type: "line", who: "akari", text: "「……我知道不急。」", expr: "低頭聲音小", depth: "near" },
    ...
    options: [
      {
        ...
        reaction: [
          ...
          { type: "line", who: "narration", text: "她沒再多說。", expr: "認真點頭微笑", depth: "near" },
      ...
      },
      {
        ...
        reaction: [
          ...
          { type: "line", who: "akari", text: "「……你問得太早了。」", expr: "耳朵紅低頭", depth: "near" },
  ...
  { type: "line", who: "narration", text: "走回來的時候，手機又震了。", se: "buzz" },
  { type: "line", who: "narration", text: "這次，她盯著螢幕看了很久。", expr: "看螢幕凝重", depth: "normal", pause: 2.0 },
  ...
  { type: "line", who: "narration", text: "她轉身往巷口走。", expr: "背對", motion: "step_back" },
